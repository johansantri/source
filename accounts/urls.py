...
from .views import (
    ...
    RestorePasswordView, RestorePasswordDoneView, RestorePasswordConfirmView, LogOutConfirmView, CoursesView,
)
...
urlpatterns = [
    ...
    path('courses/', CoursesView.as_view(), name='course_view'),
   # path('partner/', PartnerView.as_view(), name='partner_view'),
   # path('partner-add/', PartnerAdd.as_view(), name='partner_add'),
